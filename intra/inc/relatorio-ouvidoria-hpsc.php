<?php
	...
	if( isset($_POST['tipoPesquisaNumeroOuvidoriaRegistro']) && isset($_POST['numeroOuvidoriaRegistro']) ){
		...
		if($tipoPesquisaNumeroOuvidoriaRegistro == 'igual'){
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE numeroOuvidoriaRegistro = '".$numeroOuvidoriaRegistro."' ORDER BY numeroOuvidoriaRegistro;
			";
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE numeroOuvidoriaRegistro like '".$numeroOuvidoriaRegistro."%' ORDER BY numeroOuvidoriaRegistro;
			";
		...
		header('Location: ../../index.php?tela=ouvidoriaHpsc');
		...
		if($tipoPesquisaNomePaciente == 'igual'){
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE nomePaciente = '".$nomePaciente."' ORDER BY nomePaciente;
			";
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE nomePaciente like '".$nomePaciente."%' ORDER BY nomePaciente;
			";
		...
		if($tipoPesquisaCanalRecebimento == 'igual'){
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE canalRecebimento = '".$canalRecebimento."' ORDER BY canalRecebimento;
			";
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE canalRecebimento like '".$canalRecebimento."%' ORDER BY canalRecebimento;
			";
		...
		if($tipoPesquisaTipoDemanda == 'igual'){
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE tipoDemanda = '".$tipoDemanda."' ORDER BY tipoDemanda;
			";
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE tipoDemanda like '".$tipoDemanda."%' ORDER BY tipoDemanda;
			";
		...
		if($tipoPesquisaSetor == 'igual'){
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE setor = '".$setor."' ORDER BY setor;
			";
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE setor like '".$setor."%' ORDER BY setor;
			";
		...
		if($tipoPesquisaTipoOuvidoria == 'igual'){
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE tipoOuvidoria = '".$tipoOuvidoria."' ORDER BY tipoOuvidoria;
			";
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE tipoOuvidoria like '".$tipoOuvidoria."%' ORDER BY tipoOuvidoria;
			";
		...
		if($tipoPesquisaDataRegistro == 'igual'){
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE dataRegistro = '".$dataRegistro."' ORDER BY nomePaciente;
			";
			...
			$sql = "
				SELECT `numeroOuvidoriaRegistro`,`nomePaciente`, DATE_FORMAT(dataRegistro, '%d/%m/%Y') as dataRegistro ,`canalRecebimento`,`setor`,`demandaUm`,`demandaDois`,`demandaTres`,`emailGestorUm`,`emailGestorDois`,`emailGestorTres`,`emailGestorQuatro`,`emailGestorCinco`,`tipoOuvidoria`,`informacoesComplementares`,  DATE_FORMAT(dataConclusao, '%d/%m/%Y') as dataConclusao,`caminhoArquivo` 
				FROM ouvidoria_hpsc WHERE dataRegistro like '".$dataRegistro."%' ORDER BY nomePaciente;
			";
