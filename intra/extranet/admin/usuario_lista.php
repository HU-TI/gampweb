...
<head>
	...
	*/
	...
	function resetarSenha() {
		if (confirm('Confirma a reinicialização da senha do usuário selecionado?')) {
			parent.content.document.frm.target = "controle";
...
*/
$button->addItem("Novo usuário","../admin/usuario_edicao.php","content");
...
while ($rs->getrow()) {
	$id = $rs->field("cod_usuario"); // captura a chave primária do recordset
