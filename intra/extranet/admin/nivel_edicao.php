...
<head>
	...
	*/
	function salvar() {
		...
		parent.content.document.frm.action = "../<?=DIRETORIO?>/<?=OBJETO?>_salvar.php";
...
$button->addItem(" Fechar ","../".DIRETORIO."/".OBJETO."_lista.php?$retorno","content");
...
/*
	Formulário
*/
$form = new Form("frm", "../".DIRETORIO."/".OBJETO."_salvar.php", "POST", "controle", "100%");
