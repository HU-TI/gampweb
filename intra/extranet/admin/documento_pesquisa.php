...
<html>
<head>
	<title>documento-pesquisa</title>
	...
	*/
	function pesquisar() {
		...
		parent.content.document.frm.action = "../admin/documento_lista.php";
	...
	*/
	function inicializa() {
		...
		parent.content.document.frm.pesq_titulo.focus();
	}
...
$button->addItem("Fechar","../admin/documento_lista.php");
...
$form->addField("Título: ",		textField("pesq_titulo","",20,20));
$form->addField("Arquivo: ",  textField("pesq_arquivo","",50,50));
echo $form->writeHTML();
?>
</body>
</html>