...
<FORM METHOD="POST" ACTION="index.php?menu=login_validar_portal">
		...
		<table align=center width=540 cellpadding=20 border=0 cellspacing=20 bgcolor="#EFEFEF" style="border:1px dotted blue">
		<tr>
			<td align=center calign="middle">
		...
		<TR>
			...
			<TD align="left"><INPUT TYPE="text" NAME="f_username" size="30" class="input"></TD>
		</TR>		
		<TR>
			<TD class="texto_preto" align="left"><nobr>Senha:</nobr></TD>
			<TD align="left"><INPUT TYPE="password" NAME="f_senha" size="30" class="input"></TD>
		</TR>
		<TR>
			<TD></TD>
			<TD align="right">
	...
	<FORM METHOD="POST" ACTION="index_reseta.php?menu=resetar">

		<TR>
			<TD class="texto_preto">Resetar senha </TD>
			<TD align="right" >
				<INPUT TYPE="text" name="f_email" class="forme" ><input type="image" name="enviar" src="../img/bot_enviar.gif"  onmouseover="this.src='../img/bot_enviar_over.gif'" onmouseout="this.src='../img/bot_enviar.gif'">
			</TD>
		</TR>	
	</TABLE>
	</td>
