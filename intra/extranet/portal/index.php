...
<title>::: <? echo utf8_encode("Bem-vindo ao seu reequilíbrio"); ?> :::</title>
...
if (strlen(getSession("sis_username"))==0) {
		$usuario_logado = "<span class='titulo3'>".utf8_encode("Usuário")." <b>".utf8_encode("ANÔNIMO")."</b></span>";
		$link = "&nbsp;</font><a href='index.php?menu=login_portal'  class='titulo3'>LOGIN</a>";
		$default= "login_portal.php";
} else {
	$usuario_logado = "<span class='titulo3'>".utf8_encode("Usuário:")." " . getSession("sis_username") . "</span>";
 ...
 <div id="col1"></div>
   <div id="corpo">
	  <div id="menu_superior" style="align:left; border:0px solid red">
				...
				if (strlen(getSession("sis_username"))>0) {
				?>							
					<a href="http://www.reequilibrio.com.br/extranet" target="_self"><?php echo utf8_encode("Página inicial"); ?></a> |
					<a href="http://201.86.212.141/index.asp" target="_blank">Sistema</a> |
					<a href="http://www.reequilibrio.com.br" target="_blank"><?php echo utf8_encode("Site Reequilíbrio"); ?></a> |
				...
				<div id="flash1">
					<B>
						<span class='titulo4' style='float:left'>
							<?php echo utf8_encode("Bem vindo à Extranet Reequilíbrio"); ?>
						</span>
				</B>
				</div>
				</div>
...
<div id="corpo_branco" style="border-left:2px solid #007CC3">
	<div id="clinica"> 
		...
		<div id="rodape">
			<?php 
				echo utf8_encode("Reequilíbrio Clínica de Fisioterapia - Rua Grão Pará, 36 - Menino Deus - CEP 90850-170 - Fones (51): <b>3231.0688 / 3232.4660</b>");
		?>
	  </div>
		<div id="menu_index">
		<?
